...
namespace IdioSoft.Site.InterfaceLibrary.SEWC.Request
{
    ...
    public class Default : ICHttpHandler
    {
        ...
        {
            IVList vlst = new CVList(new View_SEWC_Request_Info(), context
    , "uRequestID,RequestID,NotificationNo,CreateUser,CreateDate,MLFB, SerialNo,ProductName,ProductDesc, ServiceType, Warranty");
            ...
            //objJqGridData.DicSearchFiledType.Add("NotificationNo", "string");
            //objJqGridData.DicSearchFiledType.Add("CreateUser", "string");
            ...
            //objJqGridData.DicSearchFiledType.Add("ProductName", "string");
            //objJqGridData.DicSearchFiledType.Add("ProductDesc", "string");
            //objJqGridData.DicSearchFiledType.Add("ServiceType", "string");
            ...
            //lst.Add("View_SEWC_Request_Info");
            //lst.Add(SortCol);
            //lst.Add("uRequestID,RequestID,NotificationNo,CreateUser,CreateDate,MLFB, SerialNo,ProductName,ProductDesc, ServiceType, Warranty");
            //lst.Add(CurrentPage);
            //lst.Add(PageSize);
            //lst.Add(strFilter);
            //lst.Add(Sorted);
