<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InProcessList.aspx.cs" Inherits="IdioSoft.Site.Escalation.List.InProcessList" MasterPageFile="~/Master/Csite/Site.Master" %>
        ...
        <div class="navbar" id="divNavBar">
            <div class="navbar-inner">
                <ul class="nav" id="navToolbar">
                    ...
                    <li class="divider-vertical"></li>
                    <li><a href="#" title="Activities" class="nav-icon" id="lnkActivities" data-icon="&#xe03e;"></a></li>
                </ul>
