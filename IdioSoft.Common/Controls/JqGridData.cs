...
namespace IdioSoft.Common.Controls
{
    public class JqGridData
    {
        ...
        #region "载入数据"
        public Dictionary<string, string> DicSearchFiledType = new Dictionary<string, string>();
        ...
        public string funString_FilterReturn(Dictionary<string, object> dict)
        {
                ...
                foreach (var item in dic)
                {
                    switch (intIndex)
                    {
                        case 0:
                            ...
                            strType = DicSearchFiledType[item.Value.ToString()];
                            break;
                        case 1:
