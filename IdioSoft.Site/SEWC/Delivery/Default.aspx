<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="IdioSoft.Site.SEWC.Delivery.Default" MasterPageFile="~/Master/Csite/Site.Master" %>
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="cplMain">
        ...
        <div class="navbar" id="divNavBar">
            <div class="navbar-inner">
                <ul class="nav" id="navToolbar">
                    <li runat="server" limitCode="55002"><a href="#" title="Edit" class="nav-icon" id="lnkEdit" data-icon="&#x0025;"></a></li>
                    <li runat="server" limitCode="55002"><a href="#" title="DeliveryDate(T6)" class="nav-icon" id="lnkDeliveryDate" data-icon="&#xe182;"></a></li>
                    <li class="divider-vertical"></li>
                    <li><a href="#" title="Report" class="nav-icon" id="lnkReport" data-icon="&#x0034;"></a></li>
                    <li class="divider-vertical"></li>
    ...
    <script type="text/javascript" src="../../JsLibrary/SEWC/Delivery/Default.js"></script>
</asp:Content>
