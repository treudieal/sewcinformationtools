<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="IdioSoft.Site.SEWC.IssueRepairOrder.Default" MasterPageFile="~/Master/Csite/Site.Master" %>
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="cplMain">
        ...
        <div class="navbar" id="divNavBar">
            <div class="navbar-inner">
                <ul class="nav" id="navToolbar">
                    <li runat="server" limitCode="53002" ><a href="#" title="Edit" class="nav-icon" id="lnkEdit" data-icon="&#x0025;" ></a></li>
    ...
    <script type="text/javascript" src="../../JsLibrary/SEWC/IssueRepairOrder/Default.js"></script>
</asp:Content>
