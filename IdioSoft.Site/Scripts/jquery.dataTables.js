...
(/** @lends <global> */function($, window, document, undefined) {
	...
	var DataTable = function( oInit )
	{
		...
		function _fnAjaxParameters( oSettings )
		{
			...
			{
			    aoData.push({ "name": "sSelected", "value": oSettings.oPreviousSearch.sSelected });
		...
		function _fnAjaxUpdateDraw ( oSettings, json )
		{
			...
			for ( var i=0, iLen=aData.length ; i<iLen ; i++ )
			{
				...
				{
					/* No re-order required, seveor got it "right" - just straight add */
					_fnAddData( oSettings, aData[i] );
				}
			}

			if (oSettings.aoFooter.length > 0) {
			    for (var i = 0; i < json.aaFooter.length; i++) {
			        oSettings.aoFooter[0][i].cell.innerHTML = json.aaFooter[i]; //绑定Footer，一般是合计
			    }
			}
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			var tSearchStr = oSettings.oLanguage.sSearch;
			...
			var sName = "";
			var sSelect = "";
			var aSelectColumns = oSettings.aSelectColumns;
            //当有下拉菜单绑定时才显示
			if (aSelectColumns != null && aSelectColumns.length > 0) {
			    sName = oSettings.sTableId + '_SearchSelect';
			    sSelect = '<select size="1" id="' + sName + '">';
			    var i, iLen;
			    if (aSelectColumns != null) {
			        sSelect += '<option value="All">' + "选取搜索项" + '</option>';
			        for (i = 0, iLen = aSelectColumns.length ; i < iLen ; i++) {
			            sSelect += '<option value="' + aSelectColumns[i] + '">' + aSelectColumns[i] + '</option>';
			        }
			        sSelect += '</select>';
			    }
			}
			...
			nFilter.innerHTML = '<label>' + tSearchStr + sSelect + sSearchStr + '</label>';
		...
		function _fnFilterComplete ( oSettings, oInput, iForce )
		{
			...
			var fnSaveFilter = function ( oFilter ) {
			    ...
			    oPrevSearch.sSelected = oFilter.sSelected;
		...
		return this.each(function() {
			...
			_fnMap(oSettings, oInit, "aSelectColumns");
